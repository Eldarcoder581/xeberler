...
app = Flask(__name__)
DB_PATH = 'baku_final.db'

# --- MODERN DİZAYN (Yan-yana 3 sətir) ---
HTML_TEMPLATE = """
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="container">
        {% if not data %}
            <p style="grid-column: 1/-1; text-align: center; margin-top: 50px;">
                Xəbərlər hazırlanır... <br> 30 saniyə gözləyib səhifəni yeniləyin (F5).
            </p>
        {% else %}
            {% for x in data %}
            <div class="news-card">
                ...
                <div class="news-content">
                    <div style="font-size:16px; font-weight:bold; height:50px; overflow:hidden; margin-bottom:10px;">{{ x[1] }}</div>
